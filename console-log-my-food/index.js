        ...
        case 'log': 
            ...
            function askForServingSize() {
                readline.question(
                    ...
                    servingSize => {
                        if (servingSize === 'neverming' || servingSize === 'n')
                        {
                            actionIt.return();
                        }
            ...
            async  function displayCalories(servingSize, food) {
                console.log(`${food.name} with a serving size of ${servingSize} has a ${Number.parseFloat(
                    food.calories * parseInt(servingSize, 10),
                ).toFixed()} calories. `);
                    ...
                    log: [
                        ...usersLog,
                        {
                            [Date.now()]: {
                                food: food.name,
                                servingSize,
                                calories:Number.parseFloat(food.calories * parseInt(servingSize, 10)),
                            }
                        }
                    ]
                }
            ...
            readline.question('Email: ', async emailAddress => {
                ...
                function* getFoodLog(){
                    try {
                        ...
                        console.log('Error reading de food log', {error});
                    }
                }
